...
static auto getCvars()
{
	return std::tie(
		...
		vr_hud_scale,
		vr_sbar_offset_roll,
		vr_sbar_offset_pitch,
		vr_sbar_offset_yaw
	);
}

static void SbarOffset_MenuPrintOptionValue(int cx, int cy, SbarOffsetMenuOpt option)
{
...
static void SbarOffset_MenuKeyOption(int key, SbarOffsetMenuOpt option)
{
	...
	switch (option)
	{
		case SbarOffsetMenuOpt::OffsetX:	adjustF(ox, oInc, -oBound, oBound); break;
		case SbarOffsetMenuOpt::OffsetY:	adjustF(oy, oInc, -oBound, oBound); break;
		case SbarOffsetMenuOpt::OffsetZ:	adjustF(oz, oInc, -oBound, oBound); break;
