...
void Sbar_DrawInventory(void)
{
    ...
    {
        Sbar_DrawPicAlpha(
            0, -24, sb_ibar, scr_sbaralpha.value); // johnfitz -- scr_sbaralpha
    }
...
void Sbar_Draw(void)
{
    ...
    if(sb_lines && glwidth > w)
    {
        ...
        {
            Draw_TileClear(
                0, glheight - sb_lines, (glwidth - w) / 2.0f, sb_lines);
...
void Sbar_IntermissionOverlay(void)
{
    ...
    Sbar_IntermissionNumber(
        152, 104, cl.stats[STAT_SECRETS], 3, 0); // johnfitz -- was 160
    Draw_Pic(224, 104, sb_slash);                // johnfitz -- was 232
    Sbar_IntermissionNumber(
        240, 104, cl.stats[STAT_TOTALSECRETS], 3, 0); // johnfitz -- was 248
