	...
	switch ( option ) {
		...
		case VRMenuOpt::VR_AIMMODE:
			switch ( (int)vr_aimmode.value ) {
				...
				case VR_AIMMODE_HEAD_MYAW_MPITCH:	value_string = "HEAD_MYAW_MPITCH";	break;
				case VR_AIMMODE_MOUSE_MYAW:			value_string = "MOUSE_MYAW";		break;
				case VR_AIMMODE_MOUSE_MYAW_MPITCH:	value_string = "MOUSE_MYAW_MPITCH";	break;
				case VR_AIMMODE_BLENDED:			value_string = "BLENDED";			break;
				case VR_AIMMODE_BLENDED_NOPITCH:	value_string = "BLENDED_NOPITCH"; 	break;
...
#define _maxarray(x) ( _sizeofarray(x) - 1 )
	...
	switch ( option ) {
		...
		case VRMenuOpt::VR_AIMMODE:
			...
			break;
		case VRMenuOpt::VR_DEADZONE: 					adjustF(vr_deadzone, deadzoneDiff, 0.f, 180.f); break;
		case VRMenuOpt::VR_CROSSHAIR: 					adjustI(vr_crosshair, 1, crosshair[0], crosshair[_maxarray( crosshair)  ]); break;
		case VRMenuOpt::VR_CROSSHAIR_DEPTH: 			adjustF(vr_crosshair_depth, crosshairDepthDiff, 0.f, 4096.f); break;
		case VRMenuOpt::VR_CROSSHAIR_SIZE: 				adjustF(vr_crosshair_size, crosshairSizeDiff, 0.f, 32.f); break;
		...
		case VRMenuOpt::VR_MSAA:
			...
			break;
		case VRMenuOpt::VR_GUNANGLE: 					adjustF(vr_gunangle, 0.75f, -VR_MAX_GUNANGLE, VR_MAX_GUNANGLE); break;
		case VRMenuOpt::VR_FLOOR_OFFSET: 				adjustF(vr_floor_offset, 2.5f, -VR_MAX_FLOOR_OFFSET, VR_MAX_FLOOR_OFFSET); break;
		case VRMenuOpt::VR_GUNMODELPITCH: 				adjustF(vr_gunmodelpitch, 0.25f, -90.f, 90.f); break;
